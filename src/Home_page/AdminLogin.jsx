...
const AdminLogin = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const authData = { token, user, isAdmin: true };
      ...
      <AnimatePresence>
        {forgot ? (
          ...
          >
            ...
            <button
              onClick={handleLogin}
              className="w-full p-2 text-white bg-blue-600 rounded-lg hover:bg-blue-500 transition-colors duration-300 mb-5 cursor-pointer"
            >
              Login 
            </button>
            <p
