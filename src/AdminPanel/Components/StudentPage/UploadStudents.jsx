      ...
      <div className="sm:w-full xl:w-1/2 h-[90%] bg-white shadow-xl rounded flex flex-col overflow-hidden">
        ...
        <div className="w-full h-fit pt-3">
          ...
          <input
            ...
            className="w-64 p-2 text-sm  font-semibold outline-none border-1 border-gray-500 rounded-lg ml-5"
            value={technology}
        ...
        <div className="flex flex-col justify-center items-center h-full gap-2 p-3">
          ...
          <p className="text-gray-500 text-center text-sm">
                        <strong>Note:</strong> The file should have a column
            named: <code>Student Email</code>.      
          </p>
          <label
            htmlFor="fileInput"
