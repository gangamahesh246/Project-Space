  ...
  return (
    <div className='sm:w-full h-fit'>
      ...
      <section className='sm:w-full xl:h-[163vh] bg-aliceblue'>
        ...
        <div className='xl:w-full xl:h-[100vh] sm:pt-40 lg:pt-60 flex flex-col items-center gap-5'>
          <p className='sm:w-[350px] sm:h-[50px] md:w-[450px] md:h-[70px] lg:w-[550px] lg:h-[80px] lg:text-2xl xl:w-[700px] text-center font_primary xl:text-4xl text-[#AB444C] font-bold'>Everything you need to create and conduct secure comprehensive exams</p>
          <p className='xl:w-[1000px] xl:h-[80px] md:w-[700px] lg:w-[900px] lg:text-lg text-center font_primary xl:text-xl text-primary'>We simplify all the moving pieces so you can administer your exams securely and with confidence without technical complexity.</p>
          <div className='w-full sm:flex sm:flex-col md:flex md:flex-row md:justify-center md:items-center sm:items-center lg:gap-20 xl:gap-30'>
      ...
      <footer className='w-full h-[50vh] bg-primary'>
